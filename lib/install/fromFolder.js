var copyFiles, flattenFileList, fromFolder, invokeInstallExecutable, minecraftUtils, validateManifest, winston;
...
fromFolder = function(packageDirectory, zipPath) {
  ...
  if (config.install_executable) {
    ...
    result = invokeInstallExecutable(config.install_executable, packageDirectory);
