var checkCompatibility, minecraftUtils, readManifest, semver, validateBasicInfo, validateInstallFields, validateManifest, winston;
...
checkCompatibility = function(manifest) {
  if (!semver.satisfies(minecraftUtils.getCurrentProfile().version, manifest.mc)) {
