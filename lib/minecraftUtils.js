...
module.exports = {
  ...
  getCurrentProfile: function() {
    var currentProfile, currentProfileName, launcherProfiles, pathToProfiles, ref, version;
  ...
  setCurrentProfile: function(newProfile) {
    ...
    return fs.writeFileSync(pathToProfiles, JSON.stringify(launcherProfiles, null, 2));
  },
  addInstalledPackage: function(name, version) {
    ...
    return this.setCurrentProfile(currentProfile);
  }
};
